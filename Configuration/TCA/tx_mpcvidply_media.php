...
return [
    ...
    'columns' => [
        ...
        'sign_language_display_mode' => [
            'exclude' => true,
            'label' => 'LLL:EXT:mpc_vidply/Resources/Private/Language/locallang_db.xlf:tx_mpcvidply_media.sign_language_display_mode',
            'description' => 'LLL:EXT:mpc_vidply/Resources/Private/Language/locallang_db.xlf:tx_mpcvidply_media.sign_language_display_mode.description',
            'displayCond' => 'FIELD:sign_language:REQ:true',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    ['label' => 'LLL:EXT:mpc_vidply/Resources/Private/Language/locallang_db.xlf:tx_mpcvidply_media.sign_language_display_mode.pip', 'value' => 'pip'],
                    ['label' => 'LLL:EXT:mpc_vidply/Resources/Private/Language/locallang_db.xlf:tx_mpcvidply_media.sign_language_display_mode.main', 'value' => 'main'],
                    ['label' => 'LLL:EXT:mpc_vidply/Resources/Private/Language/locallang_db.xlf:tx_mpcvidply_media.sign_language_display_mode.both', 'value' => 'both'],
                ],
                'default' => 'pip',
            ],
        ],
