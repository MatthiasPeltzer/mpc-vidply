...
- **HLS Streaming** - Adaptive bitrate streaming with **hls.js 1.7.2** (Chrome / Firefox / Edge / desktop Safari) and native HLS on iOS / iPadOS — both paths integrate with VidPly's captions, transcript and quality menus
