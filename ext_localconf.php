...
// VidPly debug overlay (`?vidplyDebug=1`) is client-only; allow it without cHash (enforceValidation).
$GLOBALS['TYPO3_CONF_VARS']['FE']['cacheHash']['excludedParameters'][] = 'vidplyDebug';
